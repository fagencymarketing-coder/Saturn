...
<!-- КАТАЛОГ СЕМЯН (светлый) -->
<section class="sec sec--light" id="catalog-seeds"><div class="wrap">
  ...
  <div class="fil"><div class="lab">Культура</div>
    ...
    <span class="chip2">{icon('zernovye',18)}Зерновые</span>
    <span class="chip2">{icon('kukuruza',18)}Кукуруза</span>
    <span class="chip2">{icon('podsolnechnik',18)}Подсолнечник</span>
    <span class="chip2">{icon('zernobob',18)}Зернобобовые</span>
  </div>
  <div class="grid">
    <div class="card"><div class="img">Фото семян</div><h3>Пшеница озимая</h3><div class="meta">зерновые · сорт</div><div class="row"><a class="btn ghost sm">Подробнее</a><a class="btn o sm">Запросить цену</a></div></div>
    <div class="card"><div class="img">Фото семян</div><h3>Кукуруза</h3><div class="meta">кукуруза · гибрид ФАО 200</div><div class="row"><a class="btn ghost sm">Подробнее</a><a class="btn o sm">Запросить цену</a></div></div>
    <div class="card"><div class="img">Фото семян</div><h3>Подсолнечник</h3><div class="meta">подсолнечник · гибрид</div><div class="row"><a class="btn ghost sm">Подробнее</a><a class="btn o sm">Запросить цену</a></div></div>
    <div class="card"><div class="img">Фото семян</div><h3>Соя</h3><div class="meta">зернобобовые · сорт</div><div class="row"><a class="btn ghost sm">Подробнее</a><a class="btn o sm">Запросить цену</a></div></div>
    <div class="card"><div class="img">Фото семян</div><h3>Ячмень яровой</h3><div class="meta">зерновые · сорт</div><div class="row"><a class="btn ghost sm">Подробнее</a><a class="btn o sm">Запросить цену</a></div></div>
    <div class="card"><div class="img">Фото семян</div><h3>Горох посевной</h3><div class="meta">зернобобовые · сорт</div><div class="row"><a class="btn ghost sm">Подробнее</a><a class="btn o sm">Запросить цену</a></div></div>
  </div>
  <div style="margin-top:24px"><a class="btn ghost">Показать ещё</a></div>
</div></section>
...
<!-- ФОРМА (светлый, без подложки) -->
<section class="sec sec--light sec--paper2" id="form"><div class="wrap">
  <div class="eyebrow">Заявка</div><h2 class="sec-h">Не нашли нужный препарат?</h2>
  <p class="sec-lead">Оставьте заявку — подберём под вашу задачу, рассчитаем нормы и отгрузим оптом.</p>
  ...
  <div class="note note--light">Нажимая «Отправить», вы соглашаетесь с политикой обработки данных. Заявка придёт на nilov@sssaturn.ru</div>
</div></section>
