...
<header class="hdr"><div class="wrap in">
  ...
  <nav class="nav">
    <a href="#catalog">Каталог</a><a href="#podbor">По культурам</a><a href="#diag">Диагностика</a>
    <a href="#agro">Агросопровождение</a><a href="#about">О компании</a><a href="#contacts">Контакты</a>
  </nav>
  <div class="right"><span class="tel">+7 960 953-48-88</span><a class="btn o sm" href="#form">Получить предложение</a></div>
</div></header>
...
<section class="hero">{HERO_WAVES}
  <div class="wrap in">
    ...
    <div class="cta-row">
      <a class="btn g" href="#podbor">Подобрать решение</a>
...
<section class="sec sec--light" id="dirs"><div class="wrap">
  <div class="eyebrow">Направления работы</div>
  ...
  <div class="dirs">
    <div class="dir">{icon('udobreniya',40)}<h3>Удобрения</h3><p>Питание растений, обработка семян, листовые и основные внесения.</p><span class="more">В каталог →</span></div>
    <div class="dir">{icon('szr',40)}<h3>СЗР</h3><p>Химические и биологические средства защиты растений.</p><span class="more">В каталог →</span></div>
    <div class="dir">{icon('semena',40)}<h3>Семена</h3><p>Сорта и гибриды сельскохозяйственных культур.</p><span class="more">В каталог →</span></div>
...
<!-- 3. БЫСТРЫЙ ПОДБОР (светлый тёплый) -->
<section class="sec sec--paper2" id="podbor"><div class="wrap">
  <div class="eyebrow">Быстрый подбор</div>
  <h2 class="sec-h">Подберём под культуру или задачу</h2>
  <p class="sec-lead">Не нужно разбираться в каталоге — выберите культуру или задачу, и специалист предложит готовое решение.</p>
  <div class="podbor">
    <div class="pcard">
    ...
    <div class="pcard">
      ...
      <div class="chips3">
        ...
        <span class="chip3 g">Коррекция дефицита</span><span class="chip3 g">Защита от сорняков</span>
        <span class="chip3 g">Защита от болезней</span><span class="chip3 g">Антистресс</span>
      </div>
    </div>
  </div>
  <div class="podbor-act">
    <a class="btn o" href="#catalog">Показать подходящие продукты</a>
    <span class="podbor-alt">Не знаете, что выбрать? <a href="#agro">Спросить агронома →</a></span>
  </div>
</div></section>
...
<section class="sec sec--dark" id="catalog"><div class="wrap">
  ...
  <p class="sec-lead">Три раздела с отдельными фильтрами: удобрения, средства защиты и семена. Ниже — примеры позиций.</p>
  <div class="fil"><div class="lab">Раздел</div>
  ...
  <div class="grid">
    <div class="card"><div class="img">Фото продукта</div><h3>Фертика Листовое Старт 13-40-13</h3><div class="meta">Фертика · комплексное удобрение</div><div class="price">от 227 ₽/кг</div><div class="row"><a class="btn ghost sm">Подробнее</a><a class="btn o sm">Рассчитать поставку</a></div></div>
    <div class="card"><div class="img">Фото продукта</div><h3>Реликт М Кремний</h3><div class="meta">Реликт · листовая подкормка</div><div class="price">от 470 ₽/л</div><div class="row"><a class="btn ghost sm">Подробнее</a><a class="btn o sm">Рассчитать поставку</a></div></div>
    ...
    <div class="card"><div class="img">Фото продукта</div><h3>Волски Биохим (линейка)</h3><div class="meta">Волски Биохим · питание</div><div class="price">Цена по запросу</div><div class="row"><a class="btn ghost sm">Подробнее</a><a class="btn o sm">Получить предложение</a></div></div>
    <div class="card"><div class="img">Фото продукта</div><h3>Протравитель (пример)</h3><div class="meta">СЗР · протравитель</div><div class="price">Цена по запросу</div><div class="row"><a class="btn ghost sm">Подробнее</a><a class="btn o sm">Получить предложение</a></div></div>
...
<section class="sec sec--dark" id="about"><div class="wrap">
  <div class="about">
    ...
    <div class="about-facts">
      ...
      <div class="af"><span>География работы</span><b>8 регионов России</b></div>
      <div class="af"><span>Направления</span><b>семена · удобрения · СЗР · сервис</b></div>
    </div>
  </div>
</div></section>
...
<!-- 8. ПРОИЗВОДИТЕЛИ (светлый тёплый) -->
<section class="sec sec--paper3" id="partners"><div class="wrap">
  <div class="eyebrow">Производители</div>
  <h2 class="sec-h">Представляем продукцию российских производителей</h2>
  <div class="partners partners-3">
    <div class="partner"><b>Фертика</b><span>минеральное питание</span><a class="plink">Смотреть продукцию →</a></div>
    <div class="partner"><b>Волски Биохим</b><span>питание растений</span><a class="plink">Смотреть продукцию →</a></div>
    <div class="partner"><b>Relict Organics</b><span>удобрения</span><a class="plink">Смотреть продукцию →</a></div>
  </div>
</div></section>
...
<!-- 10. ИСПЫТАНИЯ И РЕЗУЛЬТАТЫ (светлый) -->
<section class="sec sec--light" id="cases"><div class="wrap">
  <div class="eyebrow">Испытания и результаты</div>
  <h2 class="sec-h">Результаты производственных испытаний</h2>
  <p class="sec-lead">Данные испытаний применения продукции в конкретных хозяйствах.</p>
  <div class="cases cases--light">
    <div class="case"><div class="big">до +15%</div><h3>Пшеница</h3><p>Результат производственного испытания препаратов в конкретных условиях хозяйства.</p></div>
    <div class="case"><div class="big">+4%</div><h3>Соя</h3><p>Результат испытания продукции в конкретном хозяйстве.</p></div>
...
<section class="sec sec--light sec--paper2" id="docs"><div class="wrap">
  ...
  <p class="sec-lead">Регистрационные документы, СГР, инструкции и паспорта безопасности — по каждому продукту в каталоге.</p>
  <div class="docs">
...
<!-- 10. СПЕЦИАЛИСТЫ И КОНТАКТЫ (тёмный) -->
<section class="sec sec--dark" id="contacts"><div class="wrap">
  <div class="eyebrow">Специалисты</div>
  <h2 class="sec-h">Свяжитесь со специалистом</h2>
  <p class="sec-lead">Подскажем по ассортименту, подберём решение и рассчитаем поставку.</p>
  <div class="cts">
    <div class="person"><div class="av">фото</div><div><h3>Алексей Нилов</h3><div class="role">коммерческий руководитель · основной контакт</div><div class="tel">+7 960 953-48-88</div><div class="ch">WhatsApp · Telegram · nilov@sssaturn.ru</div></div></div>
    <div class="person"><div class="av">фото</div><div><h3>Андрей Хаблак</h3><div class="role">специалист по поставкам · зона ответственности уточняется</div><div class="tel">+7 963 502-38-55</div><div class="ch">по вопросам поставок и сопровождения</div></div></div>
  </div>
</div></section>

<!-- 11. ФОРМА ЗАПРОСА (светлый тёплый) -->
<section class="sec sec--paper2" id="form"><div class="wrap">
  <div class="eyebrow">Заявка</div>
  <h2 class="sec-h">Получить предложение</h2>
  <p class="sec-lead">Оставьте заявку — специалист подберёт решение под вашу задачу и рассчитает поставку. Культуру и объём уточним при разговоре.</p>
  <div class="form">
    ...
    <div class="submit">
      ...
      <span class="note--light">Нажимая кнопку, вы соглашаетесь с политикой обработки персональных данных.</span>
    </div>
  </div>
  <p class="cat-note">Нужен подробный расчёт? <a href="#form">Заполнить полную форму</a> — с культурой, площадью и объёмом.</p>
</div></section>
...
<footer><div class="wrap">
  <div class="fgrid">
    ...
    <div class="col"><b>Разделы</b><a href="#catalog">Каталог</a><a href="#podbor">По культурам</a><a href="#diag">Диагностика</a><a href="#agro">Агросопровождение</a><a href="#about">О компании</a><a href="#geo">География</a></div>
...
open('site-prototype-v4.html','w').write(HTML)
print("written site-prototype-v4.html size", len(HTML))
