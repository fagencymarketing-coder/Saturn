...
(async () => {
  ...
  const base = 'file://'+process.cwd()+'/site-prototype-v43.html';
  // desktop screenshot
  ...
  await p.screenshot({path:'v43-desk.png', fullPage:true});
  // mobile screenshot
  ...
  await m.screenshot({path:'v43-mob.png', fullPage:true});
  // PDF
  ...
  await pp.pdf({path:'Saturn-prototype-v43.pdf', width:'1280px', height:H+'px', printBackground:true, pageRanges:'1'});
  console.log('pdf H=',H);
  await b.close();
})();
