...
.sec--light .detail .gal{background:linear-gradient(135deg,#F1ECE4,#E7DFD3);border-color:var(--line-l);color:#B9ADA2}
...
/* tiles on dark */
.sec--dark .tile{background:var(--ink-soft);border:1px solid var(--line-d);color:var(--muted-d)}
/* clients on light */
.sec--light .client{background:var(--paper-2);border:1px dashed var(--line-l);color:var(--muted-l)}
</style>'''
...
<!-- СЕРТИФИКАТЫ (тёмный) -->
<section class="sec sec--dark" id="certs"><div class="wrap">
...
<!-- ФОРМА (тёмный, оранжевая карточка) -->
<section class="sec sec--dark" id="form"><div class="wrap"><div class="cta">
