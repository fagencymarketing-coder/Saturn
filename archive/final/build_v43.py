...
<header class="hdr"><div class="wrap in">
  ...
  <nav class="nav">
    <a href="#catalog">Каталог</a><a href="#service">Решения</a><a href="#diag">Диагностика</a>
    <a href="#geo">География</a><a href="#partners">Партнёры</a><a href="#contacts">Контакты</a>
  </nav>
...
<section class="hero">{HERO_WAVES}
  <div class="wrap in">
    ...
    <div class="cta-row">
      ...
      <a class="btn ghost-w" href="#dirs">Перейти в каталог</a>
    </div>
...
<section class="sec sec--dark" id="catalog"><div class="wrap">
  ...
  <div class="grid">
    ...
    <div class="card"><div class="img">Фото продукта</div><h3>Волски Биохим (линейка)</h3><div class="meta">Волски Биохим · питание</div><div class="price">от — ₽ <small>· цена по запросу</small></div><div class="row"><a class="btn ghost sm">Подробнее</a><a class="btn o sm">Получить предложение</a></div></div>
...
<section class="sec sec--light" id="service"><div class="wrap">
  ...
  <div class="diag" id="diag">
    <h3>{icon('diagnostika',28)}Функциональная листовая диагностика</h3>
    <p class="sec-lead" style="margin-top:8px">Собственная лаборатория «Сатурн»: определяем дефициты питания и корректируем схему под конкретное поле.</p>
    <div class="flow">
      <span class="fst">Заявка и описание проблемы</span><span class="arr">→</span>
      <span class="fst">Обследование посевов</span><span class="arr">→</span>
      <span class="fst">Листовая диагностика</span><span class="arr">→</span>
      <span class="fst">Интерпретация дефицитов</span><span class="arr">→</span>
      <span class="fst">Корректировка схемы</span><span class="arr">→</span>
      <span class="fst">Повторный контроль</span>
    </div>
    <div style="margin-top:20px"><a class="btn g" href="#form">Заказать диагностику</a></div>
  </div>
</div></section>

<!-- 6. ГЕОГРАФИЯ (тёмный) -->
<section class="sec sec--dark" id="geo"><div class="wrap">
  <div class="eyebrow">География поставок</div>
  <h2 class="sec-h">Работаем в 8 регионах</h2>
  <p class="sec-lead">Оптовые поставки и агросопровождение в ключевых аграрных регионах России.</p>
  <div class="geo">
    <div class="regions">{regions_html}</div>
    <div class="mapbox"><span class="big">8</span>регионов присутствия<br><span style="font-size:12px;font-family:'IBM Plex Mono'">карта поставок · заглушка</span></div>
  </div>
  <div class="geostat">
    <div><b>15+</b><span>лет на рынке *</span></div>
    <div><b>500+</b><span>позиций в ассортименте *</span></div>
    <div><b>1000+ т</b><span>отгружаем в год *</span></div>
    <div><b>8</b><span>регионов присутствия</span></div>
  </div>
  <p style="font-size:12px;color:var(--muted-d2);margin-top:14px;font-family:'IBM Plex Mono'">* цифры на подтверждении заказчиком</p>
</div></section>

<!-- 7. ПАРТНЁРЫ (светлый тёплый) -->
<section class="sec sec--paper3" id="partners"><div class="wrap">
  <div class="eyebrow">Производители и партнёры</div>
  <h2 class="sec-h">Представляем проверенную продукцию</h2>
  <p class="sec-lead">Работаем напрямую с производителями удобрений, средств защиты и питания растений.</p>
  <div class="partners partners-3">
    <div class="partner"><b>Фертика</b><span>минеральное питание</span></div>
    <div class="partner"><b>Волски Биохим</b><span>питание растений</span></div>
    <div class="partner"><b>Relict Organics</b><span>удобрения</span></div>
  </div>
</div></section>

<!-- 8. ИСПЫТАНИЯ И РЕЗУЛЬТАТЫ (тёмный) -->
<section class="sec sec--dark" id="cases"><div class="wrap">
  <div class="eyebrow">Испытания и результаты</div>
  <h2 class="sec-h">Результаты на полях</h2>
  <p class="sec-lead">Данные полевых испытаний применения продукции. Публикуются с согласия хозяйств.</p>
  <div class="cases">
    <div class="case"><div class="big">+15%</div><h3>Пшеница</h3><p>Прибавка урожайности при работе по схеме питания и защиты.</p><div class="who">хозяйство · СибАгро</div></div>
    <div class="case"><div class="big">+4%</div><h3>Соя</h3><p>Прибавка урожайности при листовой подкормке и сопровождении.</p><div class="who">хозяйство · СибАгро</div></div>
...
<!-- 9. ДОКУМЕНТЫ И СЕРТИФИКАТЫ (светлый) -->
<section class="sec sec--light" id="docs"><div class="wrap">
...
<section class="sec sec--dark" id="contacts"><div class="wrap">
  ...
  <div class="cts">
    <div class="person"><div class="av">фото</div><div><h3>Алексей Нилов</h3><div class="role">специалист по продукции · основной контакт</div><div class="tel">+7 960 953-48-88</div><div class="ch">WhatsApp · Telegram · nilov@sssaturn.ru</div></div></div>
    <div class="person"><div class="av">фото</div><div><h3>Андрей Хаблак</h3><div class="role">специалист по продукции</div><div class="tel">+7 963 502-38-55</div><div class="ch">по вопросам поставок и сопровождения</div></div></div>
  </div>
</div></section>
...
<section class="sec sec--paper2" id="form"><div class="wrap">
  ...
  <p class="sec-lead">Оставьте заявку — подберём решение под вашу культуру и регион, рассчитаем нормы и стоимость поставки.</p>
  <div class="form">
    <input placeholder="Имя">
    <input placeholder="Телефон *">
    <input placeholder="Регион">
    <select><option>Направление</option><option>Удобрения</option><option>СЗР</option><option>Семена</option><option>Диагностика</option><option>Агросопровождение</option></select>
    <input placeholder="Культура">
    <input placeholder="Площадь / необходимый объём">
    <input class="full" placeholder="Комментарий">
    <div class="submit">
...
<footer><div class="wrap">
  <div class="fgrid">
    ...
    <div class="col"><b>Разделы</b><a href="#dirs">Каталог</a><a href="#service">Решения</a><a href="#diag">Диагностика</a><a href="#geo">География</a><a href="#partners">Партнёры</a></div>
...
open('site-prototype-v43.html','w').write(HTML)
print("written site-prototype-v43.html size", len(HTML))
